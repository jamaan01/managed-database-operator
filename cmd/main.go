...
import (
	...
	"github.com/jamaan01/managed-database-operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "45747b76.example.com",
	})
	if err != nil {
	...
	if err := (&controller.ManagedDatabaseReconciler{
		...
		Provisioner: provisioner.NewClient("http://localhost:8080"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "manageddatabase")
		os.Exit(1)
	}
