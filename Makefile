...
KIND_CLUSTER ?= managed-database-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name managed-database-operator-builder
	$(CONTAINER_TOOL) buildx use managed-database-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm managed-database-operator-builder
	rm Dockerfile.cross
